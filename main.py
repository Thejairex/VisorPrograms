...
class Aplicacion(ttk.Frame):
    ...
    def widgets(self):
        ...
        # self.btn_buscar = ttk.Button(self.frm_lista, text='Buscar', command=self.handles)
        ...
        scrollbar_y = ttk.Scrollbar(self.frm_lista, orient="vertical", command=self.txt_consola.yview)
